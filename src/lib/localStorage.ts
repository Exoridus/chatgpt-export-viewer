...
const CODE_THEME_VALUES: ViewerPreferences['codeTheme'][] = [
  'a11yDark',
  'a11yLight',
  'monokaiSublime',
  'idea',
  ...
  getViewerPreferences(): ViewerPreferences {
    ...
    try {
      ...
      return {
        ...
        appTheme:
          parsed.appTheme === 'dark' || parsed.appTheme === 'light' || parsed.appTheme === 'system'
            ? parsed.appTheme
            : 'system',
        codeThemeFollowAppTheme:
          typeof parsed.codeThemeFollowAppTheme === 'boolean'
            ? parsed.codeThemeFollowAppTheme
            : DEFAULT_VIEWER_PREFERENCES.codeThemeFollowAppTheme,
        codeTheme:
        ...
        collapseSystemMessages:
          typeof parsed.collapseSystemMessages === 'boolean'
            ? parsed.collapseSystemMessages
            : DEFAULT_VIEWER_PREFERENCES.collapseSystemMessages,
        collapseCodeBlocks:
          typeof parsed.collapseCodeBlocks === 'boolean'
            ? parsed.collapseCodeBlocks
            : DEFAULT_VIEWER_PREFERENCES.collapseCodeBlocks,
      }
    } catch {
      return { ...DEFAULT_VIEWER_PREFERENCES }
    }
